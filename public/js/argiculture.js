...
$(document).ready(function() {
    const productRegistryContractAddress = '0xD5BcC5D4E727C692928282D559712cD700008A45'; //내 메타마스크 주소
	...
	async function showTable() {
		...
		if (window.ethereum) //메타마스크가 있을 경우
			try {
				await window.ethereum.enable();
			} catch (err) {
                return showError("Access to your Ethereum account rejected.");
			}
		if (typeof web3 === 'undefined') //없을 경우 설치할 것
